...
- `docs/` — documentation and content source files.
...
- Keep content updates in sync between `docs/hugga-website-copy.md` and React-rendered sections in `src/main.jsx`.
